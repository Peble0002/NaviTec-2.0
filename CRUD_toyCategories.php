<?php
  include 'logic_toyCategories.php';
...
<body>
  ...
  <div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-md-10">
        <h3 class="text-center text-dark mt-2">Toy Categories</h3>
        <hr>
    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <form action="CRUD_toyCategories.php" method="post" enctype="multipart/form-data">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="logic_toyCategories.php?delete=<?= $row['ID']; ?>" class="badge badge-danger p-2" onclick="return confirm('Do you want delete this record?');">Delete</a> |
                <a href="CRUD_toyCategories.php?edit=<?= $row['ID']; ?>" class="badge badge-success p-2">Edit</a>
              </td>
            </tr>
            <?php } ?>
          </tbody>
